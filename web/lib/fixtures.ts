...
export const COACH_EXAMPLES = [
  {
    title: "前向きだが決裁者が不明",
    deal_id: "D001",
    note: "村田印刷を訪問。担当者は前向きで『ほぼ決まり』との感触。受注確度は高いと見ている。ただ決裁者にはまだ会えていない。",
    hint: "高い確度が案件の実態・決裁者の状況と噛み合っているか",
  },
  {
    title: "競合と比較中",
    deal_id: "D021",
    note: "山田電機、競合製品と比較中。価格が高いと言われ、見積は提示済み。次回までに再提案する予定。",
    hint: "価格勝負に流される前に差別化軸を考える",
  },
  {
    title: "初回訪問・IT環境を確認",
    deal_id: "D016",
    note: "富士産業へ初回訪問。先方のPC環境とネットワーク構成を一通り確認できた。担当者は忙しそうだった。",
